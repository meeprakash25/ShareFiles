package com.example.sharefiles.demo;
...
import com.example.sharefiles.receiver.ReceiverActivity;
import com.example.sharefiles.sender.SHAREfilesActivity;
import com.example.sharefiles.sender.SHAREfilesService;
...
public class DemoActivity extends AppCompatActivity {
    ...
    public void sendFiles(View view) {
        if (Utils.isShareServiceRunning(getApplicationContext())) {
            startActivity(new Intent(getApplicationContext(), SHAREfilesActivity.class));
            return;
        }
        ...
        dialog.setDialogSelectionListener(new DialogSelectionListener() {
            ...
            public void onSelectedFilePaths(String[] files) {
                ...
                intent.putExtra(SHAREfilesService.EXTRA_FILE_PATHS, files);
                intent.putExtra(SHAREfilesService.EXTRA_PORT, 52287);
                intent.putExtra(SHAREfilesService.EXTRA_SENDER_NAME, "Sri");
