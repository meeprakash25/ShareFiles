package com.example.sharefiles.utils;
...
public class HotspotControl {
    ...
    /**
     * Not necessary to {@link HotspotControl} functionality but added here to help {@link SHAREfilesActivity} with port number to display connection URL
     */
     ...
     * @param port Port number assigned to {@link com.example.sharefiles.sender.SHAREfilesServer}, not used anywhere in {@link HotspotControl} but helps {@link SHAREfilesActivity} to display port info
     * @return true if {@link WifiManager}'s method is successfully called
     */
    public boolean enableShareFilesHotspot(String name, int port) {
