 ...
 */
    ...
    public static boolean connectToOpenHotspot(WifiManager mWifiManager, String netSSID, boolean disableOthers) {
        ...
        if (mWifiManager.isWifiEnabled()) {
            ...
            if (disableOthers)
                ...
                enableShareFilesNetwork(mWifiManager, netSSID);
    ...
    public static boolean enableNetworkAndDisableOthers(WifiManager wifiManager, String ssid) {
        ...
        Log.d(TAG, "enableShareFilesHotspot wifi result: " + state);
    ...
    public static boolean enableShareFilesNetwork(WifiManager wifiManager, String ssid) {
        boolean state = false;
    ...
    public static boolean isWifiConnectedToSTAccessPoint(Context context) {
        return isConnectedOnWifi(context, true) && isShareFilesSSID(((WifiManager) context.getApplicationContext().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo().getSSID());
    }

    public static boolean isShareFilesSSID(String ssid) {
