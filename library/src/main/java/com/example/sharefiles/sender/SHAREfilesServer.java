...
/**
 * A Tiny Http Server extended from {@link NanoHTTPD}. Once started, serves selected files from {@link SHAREfilesActivity} on an assigned PORT.
 * <p>
 * Created by Sri on 18/12/16.
 */

class SHAREfilesServer extends NanoHTTPD {
    ...
    public SHAREfilesServer(String host_name, int port) {
        super(host_name, port);
    }

    public SHAREfilesServer(Context context, FileTransferStatusListener statusListener, String[] filesToBeHosted) {
        this(null, 0);
        m_context = context;
    ...
    public SHAREfilesServer(Context context, FileTransferStatusListener statusListener, String[] filesToBeHosted, int port) {
        this(null, port);
        m_context = context;
        m_clientsFileTransferListener = statusListener;
        m_filesTobeHosted = filesToBeHosted;
    ...
    //  this might impact when Receiver connectivity to SHAREfiles hotspot, library checks for this scenario and prompts user to disable data
    //      For more info: https://developer.android.com/reference/android/net/wifi/WifiManager.html#enableNetwork(int, boolean)

    /**
     * Creates an Error {@link com.example.sharefiles.sender.NanoHTTPD.Response} with
     *
     * @param status  error Status like <code>Response.Status.FORBIDDEN</code>
     * @param message error message
     * @return {@link com.example.sharefiles.sender.NanoHTTPD.Response}
     */
    ...
    /**
     * Creates a success {@link com.example.sharefiles.sender.NanoHTTPD.Response} with Shared Files URLS data in @{@link com.google.gson.JsonArray} format
     *
     * @return {@link com.example.sharefiles.sender.NanoHTTPD.Response}
     */
    ...
    /**
     * Creates a success <code>Response</code> with binary data of file in {@link SHAREfilesServer#m_filesTobeHosted} with provided index.
     *
